...
Reserved Notation "'do' m" (m custom do_notation at level 10, at level 0, format "'do' '//' '[hv' m ']' '//'").
...
Notation "t 'end'" := t (in custom do_notation at level 0, t constr, format "t  '//' 'end'").
