...
(* REFERENCE: "https://leanprover.zulipchat.com/#narrow/stream/270676-lean4/topic/Bug.20in.20kernel.20level.20normalization/near/306169266" *)
...
Proof.
  ...
  exact (fun X => delta_omega (fun y => delta (sigma y) -> X) (fun x => fun e => fun f => f _ e (fun p => fun h => f _ (proj1 (sigma_tau _ _) h))) (fun p => fun h => delta_omega _ (proj1 (sigma_tau _ _) h))).
Qed.
